...
const state = {
  ...
  views:{
    ...
    caruosel: document.getElementById("carousel-cards-content")
...
state.views.caruosel.innerHTML = elements.join("");
...
async function fetchAskChampion(){
  ...
  const message = state.views.question.values
